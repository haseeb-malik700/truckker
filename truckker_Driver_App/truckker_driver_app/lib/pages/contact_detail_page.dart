...
import 'package:truckker_driver_app/pages/phone_auth_page.dart';

class ContactDetails extends StatefulWidget {
  Driver currentDriver;
  ContactDetails(this.currentDriver);
  @override
                  ...
                  CircleAvatar(
                    ...
                    child: IconButton(
                      ...
                      onPressed: userPhoneNumber == ''
                          ...
                          : () {
                        widget.currentDriver.phone="+92"+userPhoneNumber;
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                                        phoneAuthPage(widget.currentDriver),),
                              );
                            },
                    ),
                  )
